...
export default function CreateEventButtons({ isEditing, isDisabled = false, isSaving, handleSave }) {
    ...
    return (
        <div id="btn-footer">
            <Stack direction="horizontal" className="wrapper my-0 btn-group-flex">
                {isEditing && (
