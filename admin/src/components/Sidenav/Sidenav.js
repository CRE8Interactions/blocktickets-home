        ...
        <div className="position-sticky pt-3">
          <ul className="nav flex-column">
            <li className="nav-item">
              <a className={`nav-link ${enabled ? '' : 'disabled'}`} aria-current="page" href="home">
            ...
            <li className="nav-item">
              <a className={`nav-link ${enabled ? '' : 'disabled'}`} href="orders">
            ...
            <li className="nav-item">
              <a className={`nav-link ${enabled ? '' : 'disabled'}`} href="events">
            ...
            <li className="nav-item">
              <a className={`nav-link ${enabled ? '' : 'disabled'}`} href="#">
            ...
            <li className="nav-item">
              <a className={`nav-link ${enabled ? '' : 'disabled'}`} href="sales">
