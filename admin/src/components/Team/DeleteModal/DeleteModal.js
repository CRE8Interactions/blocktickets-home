...
export default function DeleteModal({ show, handleClose, removeMember, member }) {
    ...
    return (
        <Modal id="delete-modal" centered animation={false} fullscreen="md-down" show={show} onHide={handleClose} backdrop="static">
            <Modal.Body>
                <h1 className="modal-body-heading-title">Are you sure you want to delete this team member?</h1>
