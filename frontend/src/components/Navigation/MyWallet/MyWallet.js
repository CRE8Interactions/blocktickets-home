    ...
    return (
        <div id="wallet">
            <ul role="my wallet menu">
                <h5 className="name m-0 pb-3 pb-lg-4">{user?.user?.firstName} {user?.user?.lastName}</h5>
                <li className="list-item">
                    <LinkContainer to={'/my-events'} onClick={handleClick && handleClick}>
                        <Nav.Link>My events</Nav.Link>
                    </LinkContainer>
                </li>
                <li className="list-item">
                    <LinkContainer to={'/my-listings'} onClick={handleClick && handleClick}>
                        <Nav.Link>My listings</Nav.Link>
                    </LinkContainer>
                </li>
                <li className="list-item">
                    <LinkContainer to={'/my-transfers'} onClick={handleClick && handleClick}>
                ...
                <li className="list-item">
                    <LinkContainer to={'/settings'} onClick={handleClick && handleClick}>
