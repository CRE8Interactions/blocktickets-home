	...
	return (
		<Fragment>
					...
					<ul>
						...
						<li>
							...
							<dd>
								...
								which such information is collected and that alone, or jointly with others, determines
						...
						<li>
							...
							<dd>
								...
								purposes for GDPR, Personal Data means any information relating to You such as a name,
			...
			<section>
				...
				<h3 className="normal">Type of Data Collected</h3>
				<h3 className="normal mt-4">Personal Data</h3>
				<p>
				...
				<h3 className="normal mt-4">Usage Data</h3>
				<p>
					...
					pages, unique device identifiers and other diagnostic data. When You access the Service by or
					through a mobile device, We may collect certain information automatically, including, but not
					limited to, the type of mobile device You use, Your mobile device unique ID, the IP address of Your
					mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique
					device identifiers and other diagnostic data. We may also collect information that Your browser
					sends whenever You visit our Service or when You access the Service by or through a mobile device.
				</p>
				<h3 className="normal mt-4">Information from Third-Party Social Media Services</h3>
				<p>
				...
				<p>
					...
					associated with that account. You may also have the option of sharing additional information with
					the Company through Your Third-Party Social Media Service's account. If You choose to provide such
				...
				<h3 className="normal mt-4">Tracking Technologies and Cookies</h3>
				<p>
			...
			<section>
				...
				<h3 className="normal mt-4">Transfer of Your Personal Data</h3>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Detailed Information on the Processing of Your Personal Data</h2>
				<p>
				...
				<p>
					...
					third-party services for payment processing (e.g. payment processors). We will not store or collect
					Your payment card details. That information is provided directly to Our third-party payment
				...
				<p>
					...
					interests and serve You advertisements that are likely to be of more interest to You. These
				...
				<p>
					...
					browser settings that block cookies. Your browser may not permit You to block such technologies. You
					can use the following third-party tools to decline the collection and use of information for the
			...
			<section>
				...
				<h3 className="normal mt-4">Categories of Personal Information Collected</h3>
				<p>
				...
				<h3 className="normal mt-4">Sources of Personal Information</h3>
				<p>
					...
					<ul>
						...
						<li>
							...
							<dd>
								...
								third-party vendors to deliver targeted advertising to You, third-party vendors for
				...
				<p>
					...
					section. If We decide to collect additional categories of personal information or use the personal
				...
				<p>
					...
					may be and may have been disclosed. When We disclose personal information for a business purpose or
					a commercial purpose, We enter a contract that describes the purpose and requires the recipient to
					both keep that personal information confidential and not use it for any purpose except performing
					the contract.
				</p>
				<h3 className="normal mt-4">Sale of Personal Information</h3>
				<p>
					...
					valuable consideration. This means that We may have received some kind of benefit in return for
					sharing personal information, but not necessarily a monetary benefit. Please note that the
					categories listed below are those defined in the CCPA. This does not mean that all examples of that
					category of personal information were in fact sold, but reflects our good faith belief to the best
					of our knowledge that some of that information from the applicable category may be and may have been
					shared for value in return. We may sell and may have sold in the last twelve (12) months the
				...
				<h3 className="normal mt-4">Share of Personal Information</h3>
				<p>
				...
				<h3 className="normal mt-4">Sale of Personal Information of Minors Under 16 Years of Age</h3>
				<p>
				...
				<h3 className="normal mt-4">Your Rights under the CCPA</h3>
				<p>
				...
				<h3 className="normal mt-4">Exercising Your CCPA Data Protection Rights</h3>
				<p>
				...
				<ul>
					<li>
						By email: <a href="mailto:help@blocktickets.xyz">help@blocktickets.xyz</a>
					</li>
					<p>
						Only You, or a person registered with the California Secretary of State that You authorize to
						act on Your behalf, may make a verifiable request related to Your personal information. Your
						request to Us must:
					</p>
					<ul>
						<li>
				...
				<h3 className="normal mt-4">Do Not Sell My Personal Information</h3>
				<p>
					...
					Your right to opt-out, please contact Us. The Service Providers we partner with (for example, our
					analytics or advertising partners) may use technology on the Service that sells personal information
					as defined by the CCPA law. If you wish to opt out of the use of Your personal information for
					interest-based advertising purposes and these potential sales as defined under CCPA law, you may do
				...
				<ul>
					...
					<li>
						The DAA's opt-out platform:{' '}
						<a href="http://optout.aboutads.info/?c=2&lang=EN" target="_blank">
							http://optout.aboutads.info/?c=2&lang=EN
						</a>
					</li>
				</ul>
			...
			<section>
				<h2 className="docs-section-heading">Children's Privacy</h2>
				<p>
				...
				<p>
					...
					years old. In some cases, this means We will be unable to provide certain functionality of the
				...
				<p>
					...
					If the User is under the age of 13, the Service will be either blocked or redirected to a parental
					consent process.
				</p>
				<p>
					However, some third party websites do keep track of Your browsing activities. If You are visiting
				...
				<h3 className="normal mt-4">Information Collected from Children Under the Age of 13</h3>
				<p>
				...
				<p>
					We may collect and store other personal information about children if this information is submitted
				...
				<h3 className="normal mt-4">Parental Access</h3>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Links to Other Websites</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Changes to this Privacy Policy</h2>
				<p>
