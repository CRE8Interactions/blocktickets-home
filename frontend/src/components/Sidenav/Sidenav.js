      ...
      <div className="position-sticky pt-3">
        <ul className="nav flex-column">
          <li className="nav-item">
            <a className={`nav-link ${enabled ? '' : 'disabled'}`} aria-current="page" href="/dashboard">
          ...
          <li className="nav-item">
            <a className={`nav-link ${enabled ? '' : 'disabled'}`} href="/dashboard/sales">
          ...
          <li className="nav-item">
            <a className={`nav-link ${enabled ? '' : 'disabled'}`} href="/dashboard/events">
