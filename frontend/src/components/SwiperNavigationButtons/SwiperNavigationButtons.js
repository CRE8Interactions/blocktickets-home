...
export default function SwiperNavigationButtons({ styles, navigationPrevRef, navigationNextRef }) {
    return (
        <Stack direction="horizontal" className={styles}>
            <Button variant="outline-light" className='btn--icon' ref={navigationPrevRef} aria-label="left arrow">
                <svg
                    role="img"
                    title="left arrow"
                    width="25"
            ...
            <Button variant="outline-light" className="btn--icon" ref={navigationNextRef} aria-label="right arrow">
                <svg
                    role="img"
                    title="right arrow"
                    width="25"
