...
export default function TermsConditions() {
	return (
		<div className="spacer docs-container docs">
			...
			<h1 className="docs-heading">Terms & Conditions</h1>
			<p className="doc-desc">Please read these terms and conditions carefully before using Our Service.</p>
				...
				<ul>
					...
					<li>
						<dl>
							<dt>Content </dt>
							<dd>
								refers to content such as text, images, or other information that can be posted,
					...
					<li>
						<dl>
							<dt>Promotions </dt>
							<dd>refer to contests, sweepstakes or other promotions offered through the Service.</dd>
						</dl>
					</li>
					<li>
						<dl>
			...
			<section>
				<h2 className="docs-section-heading">Acknowledgment</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Placing order for goods</h2>
				<p>
				...
				<h3 className="normal mt-4">Your information</h3>
				<p>
				...
				<h3 className="normal mt-4">Order cancellation</h3>
				<p>
				...
				<h3 className="normal mt-4">Our order cancellation rights</h3>
				<p>
				...
				<p>
					...
					learn more about your right to cancel Your Order. Your right to cancel an Order only applies to
					...
					not be refunded. You should therefore take reasonable care of the purchased Goods while they are in
					Your possession. We will reimburse You no later than 14 days from the day on which We receive the
				...
				<h3 className="normal mt-2">Availability, Errors and Inaccuracies</h3>
				<p>
				...
				<h3 className="normal mt-4">Prices Policy</h3>
				<p>
				...
				<h3 className="normal mt-4">Payments</h3>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Promotions</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">User Accounts</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Content</h2>
				<p>
				...
				<h3 className="normal mt-4">Content Restrictions</h3>
				<p>
				...
				<h3 className="normal mt-4">Content Backups</h3>
				<p>
					Although regular backups of Content are performed, the Company do not guarantee there will be no
			...
			<section>
				<h2 className="docs-section-heading">Copyright Policy</h2>
				<h3 className="normal mt-4">Intellectual Property Infringement</h3>
				<p>
				...
				<p>
					...
					email at <a href="mailto:help@blocktickets.xyz">help@blocktickets.xyz</a> and include in Your notice
				...
				<h3 className="normal mt-4">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h3>
				<p>
				...
				<ul>
					...
					<li>
						...
						the copyright owner, its agent, or the law.A statement by You that You have a good faith belief
				...
				<p>
					...
					<a href="mailto:help@blocktickets.xyz">help@blocktickets.xyz</a>. Upon receipt of a notification,
					the Company will take whatever action, in its sole discretion, it deems appropriate, including
					removal of the challenged content from the Service.
				</p>
			</section>
			<section>
				<h2 className="docs-section-heading">Intellectual Property</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Your Feedback to Us</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Termination</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Governing Law</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Disputes Resolution</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">For European Union (EU) Users</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">United States Legal Compliance</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Severability and Waiver</h2>
				<h3 className="small mt-2">Severability</h3>
				<p>
					If any provision of these Terms is held to be unenforceable or invalid, such provision will be
					changed and interpreted to accomplish the objectives of such provision to the greatest extent
					possible under applicable law and the remaining provisions will continue in full force and effect.
				</p>
				<h3 className="small mt-2">Waiver</h3>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Translation Interpretation</h2>
				<p>
			...
			<section>
				<h2 className="docs-section-heading">Changes to These Terms and Conditions</h2>
				<p>
