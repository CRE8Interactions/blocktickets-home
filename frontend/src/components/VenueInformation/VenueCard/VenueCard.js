                ...
                <>
                    ...
                    <Stack
                        ...
                        <OverlayTrigger
                            ...
                            <Button variant="outline-light" className="btn--icon" aria-label="Save Venue" onClick={(e) => handleCopy(`https:google.com/maps?q=${venue?.address[0]?.address_1}+${venue?.address[0]?.city}+${venue?.address[0]?.state}`)}>
                                <svg
                                    role="img"
                                    title="save"
                                    width="21"
