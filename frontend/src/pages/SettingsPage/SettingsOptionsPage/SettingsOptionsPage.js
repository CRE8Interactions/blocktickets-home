...
export default function SettingsOptionsPage() {
	return (
		...
		<Row id="settings-options-container">
			<Col xs={12} md={5}><Link to="personal-details">
			...
			<Col  xs={12} md={5}><Link to="">
				<Card body className="card-lg card--light setting-card">
					
						<div className="card-heading">
							<Card.Title as="h5">Withdraw & Invoices</Card.Title>
							<Card.Text >
								View / Download your previous invoices and with
							</Card.Text>
						</div>
						<div className="mt-auto">
								<svg
			...
			<Col xs={12} md={5}><Link to="">
				<Card body className="card-lg card--light setting-card">
						...
						<div className="card-heading">
							...
							<Card.Text 
							>
							Add your payment information to withdrawn funds after you sell a ticket
							</Card.Text>
						</div>
						<div className="mt-auto">
								<svg
